...
sudo apt-get install php php-mysql php-ldap php-mcrypt php-cli php-soap php-json graphviz -y
sudo apt-get install php-xml php-gd php-zip php-mbstring php-curl libapache2-mod-php -y
sudo apt install php-bz2 php-sqlite3 -y
echo 'Done.'
echo
